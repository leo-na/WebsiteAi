...
max-sm:pl-10` } max-sm:fixed top-0 bottom-0 right-0
...
`}>
        ...
        >
               <img src={assets.close_icon} alt="Close menu" className="w-5" />
        </button>
...
<div className="flex items-center gap-2 sm:gap-4">
    ...
    <img src={theme === 'dark' ? assets.menu_icon_dark : assets.menu_icon} aria-label="Open menu" onClick={() => setSidebarOpen(true)} alt="Open menu" className="w-8 sm:hidden" />
